            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full sm:max-w-md">
                ...
                <form className="space-y-4">
                    <div>
                        ...
                        <input className="input-ghost-primary input max-w-full" placeholder="Email" type='email' />
                    </div>
                    <div>
                        <label htmlFor="password" className="block text-sm font-medium text-gray-700">Password</label>
                        <input className="input-ghost-primary input max-w-full" placeholder="Password" type='password' />
                    </div>
                    <div>
